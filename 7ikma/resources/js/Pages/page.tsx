import { Search, Bell, Bookmark, BookmarkIcon } from "lucide-react";
...
export default function LearnifyDashboard() {
  ...
  return (
    <div className="bg-blue-100 flex items-center justify-center min-h-screen p-4">
      <div className="bg-black rounded-3xl flex overflow-hidden" style={{ width: "1000px", height: "800px" }}>
        {/* Sidebar */}
        <div className="w-24 bg-gray-900 flex flex-col items-center py-6 gap-8">
            ...
            <div className="w-10 h-10 flex items-center justify-center">
              <div className="w-6 h-6">
                <svg viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2">
                  <path d="M12 6V12M12 12V18M12 12H18M12 12H6"></path>
                </svg>
              </div>
            </div>
          </div>
          ...
          <div className="mt-auto mb-6">
            <div className="w-10 h-10 flex items-center justify-center">
              <svg viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2">
                <path d="M12 12H19M19 12L15 8M19 12L15 16"></path>
              </svg>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 bg-white rounded-3xl p-6 overflow-y-auto">
          <div className="flex justify-between items-center mb-8">
            <div className="flex items-center">
              <span className="text-gray-600 mr-2">Welcome to</span>
              <span className="text-2xl font-bold text-orange-500">Learnify</span>
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                <input
                  type="search"
                  placeholder="Search"
                  className="py-2 px-4 pr-10 border border-gray-300 rounded-full w-64"
                />
                <button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-orange-500 rounded-full p-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="font-medium text-sm">Kacie Velasquez</div>
                  <div className="text-xs text-gray-500">@k_velasquez</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              {filteredCourses.map(course => (
                ...
                >
                  ...
                  <div className="inline-block px-3 py-1 bg-white bg-opacity-80 rounded-full text-sm mb-2">
                    {course.category}
                  </div>
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <a href="#" className="text-orange-500 text-sm">View all lessons</a>
            </div>
          ...
          <div className="bg-gray-900 rounded-3xl p-4 text-white">
            ...
            <button className="w-full bg-orange-500 text-white py-3 rounded-lg text-center">
              More details
            </button>
          </div>
        </div>
